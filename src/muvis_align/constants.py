...
# pairs per dask compute (so in flight at once) when n_parallel_pairwise_regs is blank: 2 a core keeps
# the threads busy, and one graph of all 115549 pairs took 110GB and reported nothing in 9 hours
